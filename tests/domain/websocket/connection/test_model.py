...
class TestClass:
    ...
    def valid_stub_websocket_server_protocol():
        ...
        websocket_mocked.request_headers = {
            "Sec-WebSocket-Protocol": "middle-out-protocol"
        }
        return websocket_mocked

    @staticmethod
    def test_should_get_a_valid_connection_context_instance(
    ...
    def test_should_get_a_connection_context_with_websocket_server_attributes(
        ...
        assert (
            connection_context.connection_hash
            == valid_stub_websocket_server_protocol.__hash__()
        )
