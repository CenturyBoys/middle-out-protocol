...
class TestClass:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ("/values_from_disk", MethodType.GET, *route_suite_get_decorator()),
            ("/values_from_disk", MethodType.POST, *route_suite_post_decorator()),
            ("/values_from_disk", MethodType.SUB, *route_suite_sub_decorator()),
            ("/values_from_disk", MethodType.UNSUB, *route_suite_unsub_decorator()),
        ],
